    ...
    <>
      ...
      <main className="block">
        ...
        {service.pageType === "commercial" ? (
          <CommercialServices className="bg-white pt-[3.25rem] pb-[3.25rem] lg:pt-[3.75rem] lg:pb-[3.75rem]" />
        ) : (
          <ServiceDetail
            service={service}
            className="bg-white pt-[3.25rem] pb-[3.25rem] lg:pt-[3.75rem] lg:pb-[3.75rem]"
          />
        )}
      </main>
    </>
