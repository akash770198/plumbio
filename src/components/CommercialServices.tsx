...
export function CommercialServices() {
  const { commercialServices: data } = site;
  ...
  return (
    <section
      ...
      className="bg-white pt-0 pb-[3.25rem] lg:pb-[3.75rem]"
    >
      <div className="shell">
                  ...
                  <ul key={colIdx} className="flex flex-col gap-3">
                    {col.map((item) => (
                      ...
                      >
                        ...
                        <span className="text-[15px] font-bold text-[#0a1f5c] transition-colors duration-300 group-hover:text-[#0051d4]">{item}</span>
                      </li>
                    ))}
                  </ul>
                ))}
            ...
            <Reveal delay={80}>
              <div className="relative mt-10 mb-16 overflow-visible sm:mb-20">
                <div className="relative flex min-h-[150px] items-center overflow-hidden bg-[#0b5bd3] px-6 py-9 pr-[42%] sm:min-h-[170px] sm:px-9 sm:pr-[44%] lg:min-h-[180px]">
                  {/* Dotted map texture — stronger on the right behind the van */}
                  <div
                    aria-hidden
                ...
                <div className="pointer-events-none absolute bottom-[-52px] right-[-8px] z-10 w-[56%] max-w-[380px] sm:bottom-[-64px] sm:right-[-12px] sm:w-[54%] lg:max-w-[440px]">
                  {data.bidCta.vanImage ? (
                    <div className="relative w-full">
                      {/* Soft ground shadow — contact under tires */}
                      <div
                        aria-hidden
                    ...
                    <div
                      className="relative flex aspect-[5/3] w-full items-end justify-center"
                      aria-label={data.bidCta.vanImageAlt}
                    >
                      <div
                        aria-hidden
                        className="absolute bottom-[18%] left-1/2 h-[9%] w-[68%] -translate-x-1/2 rounded-[100%] bg-black/35 blur-[7px]"
                      />
                      <div className="relative z-[1] flex h-[72%] w-full items-center justify-center border border-dashed border-white/50 bg-[#0041b0]/60 text-center text-[11px] font-medium text-white/80">
                        Van image
                      </div>
                    </div>
                  )}
            ...
            <Reveal delay={60}>
              ...
              <ul className="mt-5 bg-[#f4f6f8] px-6 py-2">
                {data.servicesList.map((item) => (
                  <li key={item} className="border-b border-[#e6eaef] last:border-b-0">
                    <Link
              ...
              <h3 className="mt-10 text-[clamp(22px,2vw,28px)] font-extrabold text-[#0a1f5c]">
              ...
              <div className="mt-8 rounded-xl bg-[#f4f6f8] px-6 py-8 shadow-[0_8px_30px_rgba(10,31,92,0.06)]">
